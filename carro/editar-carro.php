...
<div class="row">
    <div class="col">
        ...
        <h3 class="font-weight-light"> Editar Carro</h3>
            ...
            <div class="form-group">
                <input class="form-control" type="text" name="ano" id="ano" value="<?php echo $dados['ano']; ?>"
                    placeholder="Nome">
            </div>

            <div style="text-align: right;">
                <button type="submit" name="btn-editar" class="btn btn-outline-success pequeno"> Cadastrar </button>
