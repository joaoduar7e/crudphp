...
//Carro por pagina
$resultados = "SELECT * FROM carro ORDER BY nome ASC LIMIT $inicio, $quantidade";
...
<div class="espacamento">
        ...
        <div class="col-sm-4">
            <form action="pesquisar.php" method="POST">
                <div class="form-group input-group">
                    ...
                    <input name="pesquisar" id="pesquisar" placeholder="Pesquisar" type="text" class="form-control">
    ...
    <table class="table table-striped">
        ...
        while($dados = mysqli_fetch_array($resultados_carro)):
    ?>
            <tr>
                ...
                <td> <a href="editar-carro.php?id=<?php echo $dados ['id']; ?>" class="float-right">
                        <i class="material-icons"> edit </i> </a>

                    <a href="#modal<?php echo $dados['id']; ?>" class="float-right" data-toggle="modal"
                        data-target="#modal<?php echo $dados['id']; ?>">
                        <i class="material-icons"> delete </i> </a>
                </td>
                <!-- Modal -->
                <div class="modal fade" id="modal<?php echo $dados['id']; ?>" tabindex="-1" role="dialog"
